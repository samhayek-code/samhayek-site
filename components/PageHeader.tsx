  ...
  return (
    <div className="min-h-[35vh] flex flex-col justify-end p-4 lg:p-12 pt-24">
      <div className="max-w-[800px]">
        ...
        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tighter text-foreground mb-4 leading-tight">
          {h.title}
        </h1>

        <p className="font-sans text-[17px] text-muted leading-relaxed tracking-tighter">
          {h.subtitle}
        </p>
      </div>
    </div>
