...
const connectIcons: Record<string, JSX.Element> = {
  ...
  'support': (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24">
      <path d="M2 19c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2c0-1.1-1-3-3-3c-1 0-2.5.5-3.5 1c-1-.5-2.5-1-3.5-1s-2.5.5-3.5 1c-1-.5-2.5-1-3.5-1c-2 0-3 1.9-3 3z"/>
      <path d="M12 3C7 3 3 7.5 3 13c0 .5 0 1 .1 1.5C4 14 5.2 14 6 14c1 0 2.5.3 3.5.8c1-.5 2.2-.8 3.5-.8c1.3 0 2.5.3 3.5.8c1-.5 2.5-.8 3.5-.8c.8 0 2 0 2.9.5c.1-.5.1-1 .1-1.5c0-5.5-4-10-9-10z"/>
      <ellipse cx="8" cy="10" rx="1.5" ry="2"/>
      <ellipse cx="12" cy="9" rx="1" ry="1.5"/>
