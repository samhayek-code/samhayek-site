    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-start p-5">
        <div className="flex-1 pr-4">
          <span className="font-serif text-[15px] text-foreground font-semibold tracking-tighter leading-tight block">
            {item.title}
          </span>
          {item.year && (
            <span className="font-mono font-medium text-[11px] text-subtle mt-1 block">
              {item.year}
            </span>
          )}
        </div>
        ...
        >
          ...
          />
          <span className="font-mono font-medium text-[10px] text-muted uppercase tracking-wide">
            {item.label}
          </span>
        </div>
      </div>
